...
namespace CGM.Communication.MiniMed.Responses.Events
{
    ...
    [Serializable]
    public class LOW_RESERVOIR_Event : BaseEvent
    {
        [BinaryElement(0)]
        public byte WarningType { get; set; }

        [BinaryElement(1)]
        public byte HoursRemaining { get; set; }

        [BinaryElement(2)]
        public byte minutesRemaining { get; set; }

        [BinaryElement(3)]
        public InsulinDataType unitsRemaining { get; set; }
    }
