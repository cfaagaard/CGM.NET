...
namespace CGM.Communication.MiniMed.Responses.Events
{
    ...
    [Serializable]
    public class BOLUS_Event : BaseEvent
    {
        [BinaryElement(0)]
        public byte bolusSource { get; set; }

        public BolusSourceEnum bolusSourceName { get { return (BolusSourceEnum)bolusSource; } }

        [BinaryElement(1)]
        public byte bolusNumber { get; set; }
        [BinaryElement(2)]
        public byte presetBolusNumber { get; set; }
